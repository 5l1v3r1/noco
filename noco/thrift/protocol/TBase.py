...
from noco.thrift.Thrift import *
from noco.thrift.protocol import TBinaryProtocol
from noco.thrift.transport import TTransport

try:
    from noco.thrift.protocol import fastbinary
except:
    fastbinary = None
