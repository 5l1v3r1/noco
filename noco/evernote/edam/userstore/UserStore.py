...
class Iface(object):
  ...
  """
    ...
    def authenticate(
        self, username, password, consumerKey, consumerSecret, supportsTwoFactor
    ):
        """
    ...
    def completeTwoFactorAuthentication(
        self, authenticationToken, oneTimeCode, deviceIdentifier, deviceDescription
    ):
        """
  ...
  """
    ...
    def recv_checkVersion(self,):
        ...
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "checkVersion failed: unknown result"
        )
    ...
    def send_getBootstrapInfo(self, locale):
        self._oprot.writeMessageBegin(
            "getBootstrapInfo", TMessageType.CALL, self._seqid
        )
    ...
    def recv_authenticate(self,):
        ...
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "authenticate failed: unknown result"
        )
    ...
    Parameters:
     ...
     - supportsTwoFactor
    """
        self.send_authenticateLongSession(
            username,
            password,
            consumerKey,
            consumerSecret,
    ...
    def send_authenticateLongSession(
        self,
        username,
        password,
        consumerKey,
        ...
        self._oprot.writeMessageBegin(
            "authenticateLongSession", TMessageType.CALL, self._seqid
        )
    ...
    Parameters:
     ...
     - deviceDescription
    """
        self.send_completeTwoFactorAuthentication(
            authenticationToken, oneTimeCode, deviceIdentifier, deviceDescription
        )
    ...
    def send_completeTwoFactorAuthentication(
        ...
        self._oprot.writeMessageBegin(
            "completeTwoFactorAuthentication", TMessageType.CALL, self._seqid
        )
    ...
    def send_revokeLongSession(self, authenticationToken):
        self._oprot.writeMessageBegin(
            "revokeLongSession", TMessageType.CALL, self._seqid
        )
    ...
    def send_authenticateToBusiness(self, authenticationToken):
        self._oprot.writeMessageBegin(
            "authenticateToBusiness", TMessageType.CALL, self._seqid
        )
    ...
    def send_refreshAuthentication(self, authenticationToken):
        self._oprot.writeMessageBegin(
            "refreshAuthentication", TMessageType.CALL, self._seqid
        )
    ...
    def recv_getUser(self,):
        ...
        if result.systemException is not None:
            raise result.systemException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "getUser failed: unknown result"
        )
    ...
    def send_getPublicUserInfo(self, username):
        self._oprot.writeMessageBegin(
            "getPublicUserInfo", TMessageType.CALL, self._seqid
        )
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        ] = Processor.process_authenticateLongSession
        self._processMap[
        ...
        ] = Processor.process_authenticateToBusiness
        self._processMap[
            "refreshAuthentication"
        ] = Processor.process_refreshAuthentication
    ...
    def process_checkVersion(self, seqid, iprot, oprot):
        ...
        result.success = self._handler.checkVersion(
            args.clientName, args.edamVersionMajor, args.edamVersionMinor
        )
    ...
    def process_authenticateLongSession(self, seqid, iprot, oprot):
        ...
        result = authenticateLongSession_result()
        try:
            result.success = self._handler.authenticateLongSession(
                args.username,
                args.password,
                args.consumerKey,
                args.consumerSecret,
    ...
    def process_completeTwoFactorAuthentication(self, seqid, iprot, oprot):
        ...
        result = completeTwoFactorAuthentication_result()
        try:
            result.success = self._handler.completeTwoFactorAuthentication(
        ...
        oprot.writeMessageBegin(
            "completeTwoFactorAuthentication", TMessageType.REPLY, seqid
        )
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_authenticateToBusiness(self, seqid, iprot, oprot):
        ...
        result = authenticateToBusiness_result()
        try:
            result.success = self._handler.authenticateToBusiness(
                args.authenticationToken
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_refreshAuthentication(self, seqid, iprot, oprot):
        ...
        result = refreshAuthentication_result()
        try:
            result.success = self._handler.refreshAuthentication(
                args.authenticationToken
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
...
class checkVersion_args(object):
  ...
  """
    ...
    def __init__(
        self,
        clientName=None,
        edamVersionMajor=thrift_spec[2][4],
        edamVersionMinor=thrift_spec[3][4],
    ):
  ...
  """
    ...
    thrift_spec = (
        (
            ...
            TType.STRUCT,
            "success",
            (BootstrapInfo, BootstrapInfo.thrift_spec),
            None,
        ),  # 0
    )
  ...
  """
    ...
    thrift_spec = (
        (
            ...
            TType.STRUCT,
            "success",
            (AuthenticationResult, AuthenticationResult.thrift_spec),
            None,
        ),  # 0
        (
            1,
...
class revokeLongSession_result(object):
  ...
  """
    ...
    def __init__(
        self, userException=None, systemException=None,
    ):
        self.userException = userException
        self.systemException = systemException
  ...
  """
    ...
    thrift_spec = (
        (
            ...
            "success",
            (
                noco.evernote.edam.type.ttypes.User,
                noco.evernote.edam.type.ttypes.User.thrift_spec,
            ),
            None,
        ),  # 0
        (
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = noco.evernote.edam.type.ttypes.User()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
  ...
  """
    ...
    thrift_spec = (
        (
            ...
            TType.STRUCT,
            "success",
            (PublicUserInfo, PublicUserInfo.thrift_spec),
            None,
        ),  # 0
        (
            1,
  ...
  """
    ...
    thrift_spec = (
        (
            ...
            "success",
            (
                noco.evernote.edam.type.ttypes.PremiumInfo,
                noco.evernote.edam.type.ttypes.PremiumInfo.thrift_spec,
            ),
            None,
        ),  # 0
        (
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = noco.evernote.edam.type.ttypes.PremiumInfo()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
