    ...
    def validate(self):
        if self.userId is None:
            raise TProtocol.TProtocolException(
                message="Required field userId is unset!"
            )
        if self.shardId is None:
            raise TProtocol.TProtocolException(
                message="Required field shardId is unset!"
            )
        return
...
class AuthenticationResult(object):
  ...
  """
    ...
    def __init__(
        ...
        noteStoreUrl=None,
        webApiUrlPrefix=None,
        secondFactorRequired=None,
        secondFactorDeliveryHint=None,
    ):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.user = noco.evernote.edam.type.ttypes.User()
    ...
    def validate(self):
        ...
        if self.authenticationToken is None:
            raise TProtocol.TProtocolException(
                message="Required field authenticationToken is unset!"
            )
        if self.expiration is None:
            raise TProtocol.TProtocolException(
                message="Required field expiration is unset!"
            )
        return
...
class BootstrapSettings(object):
  ...
  """
    ...
    def __init__(
        ...
        marketingUrl=None,
        supportUrl=None,
        accountEmailDomain=None,
        enableFacebookSharing=None,
        enableGiftSubscriptions=None,
        enableSupportTickets=None,
        enableSharedNotebooks=None,
        enableSingleNoteSharing=None,
        enableSponsoredAccounts=None,
        enableTwitterSharing=None,
        enableLinkedInSharing=None,
        enablePublicNotebooks=None,
    ):
    ...
    def validate(self):
        if self.serviceHost is None:
            raise TProtocol.TProtocolException(
                message="Required field serviceHost is unset!"
            )
        if self.marketingUrl is None:
            raise TProtocol.TProtocolException(
                message="Required field marketingUrl is unset!"
            )
        if self.supportUrl is None:
            raise TProtocol.TProtocolException(
                message="Required field supportUrl is unset!"
            )
        if self.accountEmailDomain is None:
            raise TProtocol.TProtocolException(
                message="Required field accountEmailDomain is unset!"
            )
        return
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            TType.STRUCT,
            "settings",
            (BootstrapSettings, BootstrapSettings.thrift_spec),
            None,
        ),  # 2
    )

    def __init__(
        self, name=None, settings=None,
    ):
        self.name = name
    ...
    def validate(self):
        ...
        if self.settings is None:
            raise TProtocol.TProtocolException(
                message="Required field settings is unset!"
            )
        return
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            TType.LIST,
            "profiles",
            (TType.STRUCT, (BootstrapProfile, BootstrapProfile.thrift_spec)),
            None,
        ),  # 1
    )
    ...
    def validate(self):
        if self.profiles is None:
            raise TProtocol.TProtocolException(
                message="Required field profiles is unset!"
            )
        return
