...
class EDAMUserException(TException):
  ...
  """
    ...
    def __init__(
        self, errorCode=None, parameter=None,
    ):
    ...
    def validate(self):
        if self.errorCode is None:
            raise TProtocol.TProtocolException(
                message="Required field errorCode is unset!"
            )
        return
...
class EDAMSystemException(TException):
  ...
  """
    ...
    def __init__(
        self, errorCode=None, message=None, rateLimitDuration=None,
    ):
