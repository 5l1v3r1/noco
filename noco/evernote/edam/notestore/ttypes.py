...
import noco.evernote.edam.userstore.ttypes
import noco.evernote.edam.type.ttypes
import noco.evernote.edam.error.ttypes
import noco.evernote.edam.limits.ttypes
...
class SyncState(object):
  ...
  """
    ...
    def __init__(
        self, currentTime=None, fullSyncBefore=None, updateCount=None, uploaded=None,
    ):
    ...
    def validate(self):
        if self.currentTime is None:
            raise TProtocol.TProtocolException(
                message="Required field currentTime is unset!"
            )
        if self.fullSyncBefore is None:
            raise TProtocol.TProtocolException(
                message="Required field fullSyncBefore is unset!"
            )
        if self.updateCount is None:
            raise TProtocol.TProtocolException(
                message="Required field updateCount is unset!"
            )
        return
...
class SyncChunk(object):
  ...
  """
    ...
    def __init__(
        ...
        expungedTags=None,
        expungedSearches=None,
        linkedNotebooks=None,
        expungedLinkedNotebooks=None,
    ):
        self.currentTime = currentTime
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i4 in range(_size0):
                        _elem5 = noco.evernote.edam.type.ttypes.Note()
                        _elem5.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i10 in range(_size6):
                        _elem11 = noco.evernote.edam.type.ttypes.Notebook()
                        _elem11.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i16 in range(_size12):
                        _elem17 = noco.evernote.edam.type.ttypes.Tag()
                        _elem17.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i22 in range(_size18):
                        _elem23 = noco.evernote.edam.type.ttypes.SavedSearch()
                        _elem23.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i28 in range(_size24):
                        _elem29 = noco.evernote.edam.type.ttypes.Resource()
                        _elem29.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i58 in range(_size54):
                        _elem59 = noco.evernote.edam.type.ttypes.LinkedNotebook()
                        _elem59.read(iprot)
...
class SyncChunkFilter(object):
  ...
  """
    ...
    def __init__(
        self,
        includeNotes=None,
        includeNoteResources=None,
        includeNoteAttributes=None,
        includeNotebooks=None,
        includeTags=None,
        includeSearches=None,
        includeResources=None,
        includeLinkedNotebooks=None,
        includeExpunged=None,
        includeNoteApplicationDataFullMap=None,
        includeResourceApplicationDataFullMap=None,
        includeNoteResourceApplicationDataFullMap=None,
        ...
        self.includeResourceApplicationDataFullMap = (
            includeResourceApplicationDataFullMap
        )
        self.includeNoteResourceApplicationDataFullMap = (
            includeNoteResourceApplicationDataFullMap
        )
  ...
  """
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i88 in range(_size84):
                        _elem89 = noco.evernote.edam.type.ttypes.Note()
                        _elem89.read(iprot)
    ...
    def validate(self):
        if self.startIndex is None:
            raise TProtocol.TProtocolException(
                message="Required field startIndex is unset!"
            )
        if self.totalNotes is None:
            raise TProtocol.TProtocolException(
                message="Required field totalNotes is unset!"
            )
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            "attributes",
            (
                noco.evernote.edam.type.ttypes.NoteAttributes,
                noco.evernote.edam.type.ttypes.NoteAttributes.thrift_spec,
            ),
            None,
        ),  # 14
        None,  # 15
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.attributes = noco.evernote.edam.type.ttypes.NoteAttributes()
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            TType.LIST,
            "notes",
            (TType.STRUCT, (NoteMetadata, NoteMetadata.thrift_spec)),
            None,
        ),  # 3
        (4, TType.LIST, "stoppedWords", (TType.STRING, None), None,),  # 4
        (5, TType.LIST, "searchedWords", (TType.STRING, None), None,),  # 5
...
class NotesMetadataResultSpec(object):
  ...
  """
    ...
    def __init__(
        self,
        includeTitle=None,
        includeContentLength=None,
        includeCreated=None,
        includeUpdated=None,
        includeDeleted=None,
        includeUpdateSequenceNum=None,
        includeNotebookGuid=None,
        includeTagGuids=None,
        includeAttributes=None,
        includeLargestResourceMime=None,
...
class NoteCollectionCounts(object):
  ...
  """
    ...
    def __init__(
        self, notebookCounts=None, tagCounts=None, trashCount=None,
    ):
...
class NoteVersionId(object):
  ...
  """
    ...
    def __init__(
        self, updateSequenceNum=None, updated=None, saved=None, title=None,
    ):
        self.updateSequenceNum = updateSequenceNum
        self.updated = updated
        self.saved = saved
    ...
    def validate(self):
        if self.updateSequenceNum is None:
            raise TProtocol.TProtocolException(
                message="Required field updateSequenceNum is unset!"
            )
        if self.updated is None:
            raise TProtocol.TProtocolException(
                message="Required field updated is unset!"
            )
...
class RelatedQuery(object):
  ...
  """
    ...
    def __init__(
        self, noteGuid=None, plainText=None, filter=None, referenceUri=None,
    ):
...
class RelatedResult(object):
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            (
                TType.STRUCT,
                (
                    noco.evernote.edam.type.ttypes.NotebookDescriptor,
                    noco.evernote.edam.type.ttypes.NotebookDescriptor.thrift_spec,
                ),
            ),
            None,
        ),  # 4
    ...
    def __init__(
        self, notes=None, notebooks=None, tags=None, containingNotebooks=None,
    ):
        self.notes = notes
        self.notebooks = notebooks
        self.tags = tags
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i169 in range(_size165):
                        _elem170 = noco.evernote.edam.type.ttypes.Note()
                        _elem170.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i175 in range(_size171):
                        _elem176 = noco.evernote.edam.type.ttypes.Notebook()
                        _elem176.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i181 in range(_size177):
                        _elem182 = noco.evernote.edam.type.ttypes.Tag()
                        _elem182.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i187 in range(_size183):
                        _elem188 = noco.evernote.edam.type.ttypes.NotebookDescriptor()
                        _elem188.read(iprot)
