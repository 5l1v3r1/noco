...
from noco.thrift.Thrift import TType, TMessageType, TException, TApplicationException
from .ttypes import *
from noco.thrift.Thrift import TProcessor
from noco.thrift.transport import TTransport
from noco.thrift.protocol import TBinaryProtocol, TProtocol
...
class Iface(object):
    ...
    def findNotesMetadata(
        self, authenticationToken, filter, offset, maxNotes, resultSpec
    ):
        """
    ...
    def getNoteSearchText(
        self, authenticationToken, guid, noteOnly, tokenizeForIndexing
    ):
        """
    ...
    def setSharedNotebookRecipientSettings(
        self, authenticationToken, sharedNotebookId, recipientSettings
    ):
        """
    ...
    def sendMessageToSharedNotebookMembers(
        self, authenticationToken, notebookGuid, messageText, recipients
    ):
        """
...
class Client(Iface):
    ...
    def recv_getSyncState(self,):
        ...
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "getSyncState failed: unknown result"
        )
    ...
    def send_getSyncStateWithMetrics(self, authenticationToken, clientMetrics):
        self._oprot.writeMessageBegin(
            "getSyncStateWithMetrics", TMessageType.CALL, self._seqid
        )
    ...
    def send_getSyncChunk(
        self, authenticationToken, afterUSN, maxEntries, fullSyncOnly
    ):
    ...
    def recv_getSyncChunk(self,):
        ...
        if result.systemException is not None:
            raise result.systemException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "getSyncChunk failed: unknown result"
        )
    ...
    Parameters:
     ...
     - filter
    """
        self.send_getFilteredSyncChunk(
            authenticationToken, afterUSN, maxEntries, filter
        )
        return self.recv_getFilteredSyncChunk()

    def send_getFilteredSyncChunk(
        self, authenticationToken, afterUSN, maxEntries, filter
    ):
        self._oprot.writeMessageBegin(
            "getFilteredSyncChunk", TMessageType.CALL, self._seqid
        )
    ...
    def send_getLinkedNotebookSyncState(self, authenticationToken, linkedNotebook):
        self._oprot.writeMessageBegin(
            "getLinkedNotebookSyncState", TMessageType.CALL, self._seqid
        )
    ...
    Parameters:
     ...
     - fullSyncOnly
    """
        self.send_getLinkedNotebookSyncChunk(
            authenticationToken, linkedNotebook, afterUSN, maxEntries, fullSyncOnly
        )
        return self.recv_getLinkedNotebookSyncChunk()

    def send_getLinkedNotebookSyncChunk(
        self, authenticationToken, linkedNotebook, afterUSN, maxEntries, fullSyncOnly
    ):
        self._oprot.writeMessageBegin(
            "getLinkedNotebookSyncChunk", TMessageType.CALL, self._seqid
        )
    ...
    def recv_listNotebooks(self,):
        ...
        if result.systemException is not None:
            raise result.systemException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "listNotebooks failed: unknown result"
        )
    ...
    def recv_getNotebook(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "getNotebook failed: unknown result"
        )
    ...
    def send_getDefaultNotebook(self, authenticationToken):
        self._oprot.writeMessageBegin(
            "getDefaultNotebook", TMessageType.CALL, self._seqid
        )
    ...
    def recv_listTags(self,):
        ...
        if result.systemException is not None:
            raise result.systemException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "listTags failed: unknown result"
        )
    ...
    def send_listTagsByNotebook(self, authenticationToken, notebookGuid):
        self._oprot.writeMessageBegin(
            "listTagsByNotebook", TMessageType.CALL, self._seqid
        )
    ...
    def recv_getTag(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "getTag failed: unknown result"
        )
    ...
    def recv_createTag(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "createTag failed: unknown result"
        )
    ...
    def recv_updateTag(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "updateTag failed: unknown result"
        )
    ...
    def recv_expungeTag(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "expungeTag failed: unknown result"
        )
    ...
    def recv_listSearches(self,):
        ...
        if result.systemException is not None:
            raise result.systemException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "listSearches failed: unknown result"
        )
    ...
    def recv_getSearch(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "getSearch failed: unknown result"
        )
    ...
    def recv_createSearch(self,):
        ...
        if result.systemException is not None:
            raise result.systemException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "createSearch failed: unknown result"
        )
    ...
    def recv_updateSearch(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "updateSearch failed: unknown result"
        )
    ...
    def recv_expungeSearch(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "expungeSearch failed: unknown result"
        )
    ...
    def recv_findNotes(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "findNotes failed: unknown result"
        )
    ...
    Parameters:
     ...
     - resultSpec
    """
        self.send_findNotesMetadata(
            authenticationToken, filter, offset, maxNotes, resultSpec
        )
        return self.recv_findNotesMetadata()

    def send_findNotesMetadata(
        self, authenticationToken, filter, offset, maxNotes, resultSpec
    ):
        self._oprot.writeMessageBegin(
            "findNotesMetadata", TMessageType.CALL, self._seqid
        )
    ...
    def recv_getNote(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "getNote failed: unknown result"
        )
    ...
    def send_getNoteApplicationData(self, authenticationToken, guid):
        self._oprot.writeMessageBegin(
            "getNoteApplicationData", TMessageType.CALL, self._seqid
        )
    ...
    def send_getNoteApplicationDataEntry(self, authenticationToken, guid, key):
        self._oprot.writeMessageBegin(
            "getNoteApplicationDataEntry", TMessageType.CALL, self._seqid
        )
    ...
    def send_setNoteApplicationDataEntry(self, authenticationToken, guid, key, value):
        self._oprot.writeMessageBegin(
            "setNoteApplicationDataEntry", TMessageType.CALL, self._seqid
        )
    ...
    def send_unsetNoteApplicationDataEntry(self, authenticationToken, guid, key):
        self._oprot.writeMessageBegin(
            "unsetNoteApplicationDataEntry", TMessageType.CALL, self._seqid
        )
    ...
    Parameters:
     ...
     - tokenizeForIndexing
    """
        self.send_getNoteSearchText(
            authenticationToken, guid, noteOnly, tokenizeForIndexing
        )
        return self.recv_getNoteSearchText()

    def send_getNoteSearchText(
        self, authenticationToken, guid, noteOnly, tokenizeForIndexing
    ):
        self._oprot.writeMessageBegin(
            "getNoteSearchText", TMessageType.CALL, self._seqid
        )
    ...
    def send_getResourceSearchText(self, authenticationToken, guid):
        self._oprot.writeMessageBegin(
            "getResourceSearchText", TMessageType.CALL, self._seqid
        )
    ...
    def recv_createNote(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "createNote failed: unknown result"
        )
    ...
    def recv_updateNote(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "updateNote failed: unknown result"
        )
    ...
    def recv_deleteNote(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "deleteNote failed: unknown result"
        )
    ...
    def recv_expungeNote(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "expungeNote failed: unknown result"
        )
    ...
    def recv_expungeNotes(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "expungeNotes failed: unknown result"
        )
    ...
    def send_expungeInactiveNotes(self, authenticationToken):
        self._oprot.writeMessageBegin(
            "expungeInactiveNotes", TMessageType.CALL, self._seqid
        )
    ...
    def recv_copyNote(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "copyNote failed: unknown result"
        )
    ...
    def send_listNoteVersions(self, authenticationToken, noteGuid):
        self._oprot.writeMessageBegin(
            "listNoteVersions", TMessageType.CALL, self._seqid
        )
    ...
    def recv_getResource(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "getResource failed: unknown result"
        )
    ...
    def send_getResourceApplicationData(self, authenticationToken, guid):
        self._oprot.writeMessageBegin(
            "getResourceApplicationData", TMessageType.CALL, self._seqid
        )
    ...
    def send_getResourceApplicationDataEntry(self, authenticationToken, guid, key):
        self._oprot.writeMessageBegin(
            "getResourceApplicationDataEntry", TMessageType.CALL, self._seqid
        )
    ...
    def send_setResourceApplicationDataEntry(
        self, authenticationToken, guid, key, value
    ):
        self._oprot.writeMessageBegin(
            "setResourceApplicationDataEntry", TMessageType.CALL, self._seqid
        )
    ...
    def send_unsetResourceApplicationDataEntry(self, authenticationToken, guid, key):
        self._oprot.writeMessageBegin(
            "unsetResourceApplicationDataEntry", TMessageType.CALL, self._seqid
        )
    ...
    def send_getResourceByHash(
        ...
        self._oprot.writeMessageBegin(
            "getResourceByHash", TMessageType.CALL, self._seqid
        )
    ...
    def send_getResourceRecognition(self, authenticationToken, guid):
        self._oprot.writeMessageBegin(
            "getResourceRecognition", TMessageType.CALL, self._seqid
        )
    ...
    def send_getResourceAlternateData(self, authenticationToken, guid):
        self._oprot.writeMessageBegin(
            "getResourceAlternateData", TMessageType.CALL, self._seqid
        )
    ...
    def send_getResourceAttributes(self, authenticationToken, guid):
        self._oprot.writeMessageBegin(
            "getResourceAttributes", TMessageType.CALL, self._seqid
        )
    ...
    def send_getPublicNotebook(self, userId, publicUri):
        self._oprot.writeMessageBegin(
            "getPublicNotebook", TMessageType.CALL, self._seqid
        )
    ...
    def send_createSharedNotebook(self, authenticationToken, sharedNotebook):
        self._oprot.writeMessageBegin(
            "createSharedNotebook", TMessageType.CALL, self._seqid
        )
    ...
    def send_updateSharedNotebook(self, authenticationToken, sharedNotebook):
        self._oprot.writeMessageBegin(
            "updateSharedNotebook", TMessageType.CALL, self._seqid
        )
    ...
    Parameters:
     ...
     - recipientSettings
    """
        self.send_setSharedNotebookRecipientSettings(
            authenticationToken, sharedNotebookId, recipientSettings
        )
        return self.recv_setSharedNotebookRecipientSettings()

    def send_setSharedNotebookRecipientSettings(
        self, authenticationToken, sharedNotebookId, recipientSettings
    ):
        self._oprot.writeMessageBegin(
            "setSharedNotebookRecipientSettings", TMessageType.CALL, self._seqid
        )
    ...
    Parameters:
     ...
     - recipients
    """
        self.send_sendMessageToSharedNotebookMembers(
            authenticationToken, notebookGuid, messageText, recipients
        )
        return self.recv_sendMessageToSharedNotebookMembers()

    def send_sendMessageToSharedNotebookMembers(
        self, authenticationToken, notebookGuid, messageText, recipients
    ):
        self._oprot.writeMessageBegin(
            "sendMessageToSharedNotebookMembers", TMessageType.CALL, self._seqid
        )
    ...
    def send_listSharedNotebooks(self, authenticationToken):
        self._oprot.writeMessageBegin(
            "listSharedNotebooks", TMessageType.CALL, self._seqid
        )
    ...
    def send_expungeSharedNotebooks(self, authenticationToken, sharedNotebookIds):
        self._oprot.writeMessageBegin(
            "expungeSharedNotebooks", TMessageType.CALL, self._seqid
        )
    ...
    def send_createLinkedNotebook(self, authenticationToken, linkedNotebook):
        self._oprot.writeMessageBegin(
            "createLinkedNotebook", TMessageType.CALL, self._seqid
        )
    ...
    def send_updateLinkedNotebook(self, authenticationToken, linkedNotebook):
        self._oprot.writeMessageBegin(
            "updateLinkedNotebook", TMessageType.CALL, self._seqid
        )
    ...
    def send_listLinkedNotebooks(self, authenticationToken):
        self._oprot.writeMessageBegin(
            "listLinkedNotebooks", TMessageType.CALL, self._seqid
        )
    ...
    def send_expungeLinkedNotebook(self, authenticationToken, guid):
        self._oprot.writeMessageBegin(
            "expungeLinkedNotebook", TMessageType.CALL, self._seqid
        )
    ...
    def send_authenticateToSharedNotebook(self, shareKey, authenticationToken):
        self._oprot.writeMessageBegin(
            "authenticateToSharedNotebook", TMessageType.CALL, self._seqid
        )
    ...
    def send_getSharedNotebookByAuth(self, authenticationToken):
        self._oprot.writeMessageBegin(
            "getSharedNotebookByAuth", TMessageType.CALL, self._seqid
        )
    ...
    def recv_shareNote(self,):
        ...
        if result.systemException is not None:
            raise result.systemException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "shareNote failed: unknown result"
        )
    ...
    def send_authenticateToSharedNote(self, guid, noteKey, authenticationToken):
        self._oprot.writeMessageBegin(
            "authenticateToSharedNote", TMessageType.CALL, self._seqid
        )
    ...
    def recv_findRelated(self,):
        ...
        if result.notFoundException is not None:
            raise result.notFoundException
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "findRelated failed: unknown result"
        )
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        ] = Processor.process_getSyncStateWithMetrics
        self._processMap["getSyncChunk"] = Processor.process_getSyncChunk
        self._processMap[
            "getFilteredSyncChunk"
        ] = Processor.process_getFilteredSyncChunk
        self._processMap[
            "getLinkedNotebookSyncState"
        ] = Processor.process_getLinkedNotebookSyncState
        self._processMap[
            "getLinkedNotebookSyncChunk"
        ] = Processor.process_getLinkedNotebookSyncChunk
        ...
        ] = Processor.process_getNoteApplicationData
        self._processMap[
            "getNoteApplicationDataEntry"
        ] = Processor.process_getNoteApplicationDataEntry
        self._processMap[
            "setNoteApplicationDataEntry"
        ] = Processor.process_setNoteApplicationDataEntry
        self._processMap[
            "unsetNoteApplicationDataEntry"
        ] = Processor.process_unsetNoteApplicationDataEntry
        ...
        ] = Processor.process_getResourceSearchText
        ...
        ] = Processor.process_expungeInactiveNotes
        ...
        ] = Processor.process_getResourceApplicationData
        self._processMap[
            "getResourceApplicationDataEntry"
        ] = Processor.process_getResourceApplicationDataEntry
        self._processMap[
            "setResourceApplicationDataEntry"
        ] = Processor.process_setResourceApplicationDataEntry
        self._processMap[
            "unsetResourceApplicationDataEntry"
        ] = Processor.process_unsetResourceApplicationDataEntry
        ...
        ] = Processor.process_getResourceRecognition
        self._processMap[
            "getResourceAlternateData"
        ] = Processor.process_getResourceAlternateData
        self._processMap[
            "getResourceAttributes"
        ] = Processor.process_getResourceAttributes
        ...
        ] = Processor.process_updateSharedNotebook
        self._processMap[
            "setSharedNotebookRecipientSettings"
        ] = Processor.process_setSharedNotebookRecipientSettings
        self._processMap[
            "sendMessageToSharedNotebookMembers"
        ] = Processor.process_sendMessageToSharedNotebookMembers
        self._processMap["listSharedNotebooks"] = Processor.process_listSharedNotebooks
        self._processMap[
            "expungeSharedNotebooks"
        ] = Processor.process_expungeSharedNotebooks
        self._processMap[
            "createLinkedNotebook"
        ] = Processor.process_createLinkedNotebook
        self._processMap[
            "updateLinkedNotebook"
        ] = Processor.process_updateLinkedNotebook
        self._processMap["listLinkedNotebooks"] = Processor.process_listLinkedNotebooks
        self._processMap[
            "expungeLinkedNotebook"
        ] = Processor.process_expungeLinkedNotebook
        self._processMap[
            "authenticateToSharedNotebook"
        ] = Processor.process_authenticateToSharedNotebook
        self._processMap[
        ...
        ] = Processor.process_authenticateToSharedNote
    ...
    def process_getSyncState(self, seqid, iprot, oprot):
        ...
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
    ...
    def process_getSyncStateWithMetrics(self, seqid, iprot, oprot):
        ...
        result = getSyncStateWithMetrics_result()
        try:
            result.success = self._handler.getSyncStateWithMetrics(
                args.authenticationToken, args.clientMetrics
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
    ...
    def process_getSyncChunk(self, seqid, iprot, oprot):
        ...
        result = getSyncChunk_result()
        try:
            result.success = self._handler.getSyncChunk(
    ...
    def process_getFilteredSyncChunk(self, seqid, iprot, oprot):
        ...
        result = getFilteredSyncChunk_result()
        try:
            result.success = self._handler.getFilteredSyncChunk(
                args.authenticationToken, args.afterUSN, args.maxEntries, args.filter
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
    ...
    def process_getLinkedNotebookSyncState(self, seqid, iprot, oprot):
        ...
        result = getLinkedNotebookSyncState_result()
        try:
            result.success = self._handler.getLinkedNotebookSyncState(
                args.authenticationToken, args.linkedNotebook
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
            result.systemException = systemException
        except noco.evernote.edam.error.ttypes.EDAMNotFoundException as notFoundException:
    ...
    def process_getLinkedNotebookSyncChunk(self, seqid, iprot, oprot):
        ...
        result = getLinkedNotebookSyncChunk_result()
        try:
            result.success = self._handler.getLinkedNotebookSyncChunk(
                args.authenticationToken,
                args.linkedNotebook,
                args.afterUSN,
                args.maxEntries,
    ...
    def process_getNotebook(self, seqid, iprot, oprot):
        ...
        result = getNotebook_result()
        try:
            result.success = self._handler.getNotebook(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
    ...
    def process_createNotebook(self, seqid, iprot, oprot):
        ...
        result = createNotebook_result()
        try:
            result.success = self._handler.createNotebook(
                args.authenticationToken, args.notebook
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
    ...
    def process_updateNotebook(self, seqid, iprot, oprot):
        ...
        result = updateNotebook_result()
        try:
            result.success = self._handler.updateNotebook(
                args.authenticationToken, args.notebook
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_expungeNotebook(self, seqid, iprot, oprot):
        ...
        result = expungeNotebook_result()
        try:
            result.success = self._handler.expungeNotebook(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_listTagsByNotebook(self, seqid, iprot, oprot):
        ...
        result = listTagsByNotebook_result()
        try:
            result.success = self._handler.listTagsByNotebook(
                args.authenticationToken, args.notebookGuid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
    ...
    def process_expungeTag(self, seqid, iprot, oprot):
        ...
        result = expungeTag_result()
        try:
            result.success = self._handler.expungeTag(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_getSearch(self, seqid, iprot, oprot):
        ...
        result = getSearch_result()
        try:
            result.success = self._handler.getSearch(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_createSearch(self, seqid, iprot, oprot):
        ...
        result = createSearch_result()
        try:
            result.success = self._handler.createSearch(
                args.authenticationToken, args.search
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
    ...
    def process_updateSearch(self, seqid, iprot, oprot):
        ...
        result = updateSearch_result()
        try:
            result.success = self._handler.updateSearch(
                args.authenticationToken, args.search
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_expungeSearch(self, seqid, iprot, oprot):
        ...
        result = expungeSearch_result()
        try:
            result.success = self._handler.expungeSearch(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_findNotes(self, seqid, iprot, oprot):
        ...
        result = findNotes_result()
        try:
            result.success = self._handler.findNotes(
                args.authenticationToken, args.filter, args.offset, args.maxNotes
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
    ...
    def process_findNoteOffset(self, seqid, iprot, oprot):
        ...
        result = findNoteOffset_result()
        try:
            result.success = self._handler.findNoteOffset(
                args.authenticationToken, args.filter, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
    ...
    def process_findNotesMetadata(self, seqid, iprot, oprot):
        ...
        result = findNotesMetadata_result()
        try:
            result.success = self._handler.findNotesMetadata(
                args.authenticationToken,
                args.filter,
                args.offset,
                args.maxNotes,
    ...
    def process_findNoteCounts(self, seqid, iprot, oprot):
        ...
        result = findNoteCounts_result()
        try:
            result.success = self._handler.findNoteCounts(
                args.authenticationToken, args.filter, args.withTrash
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
    ...
    def process_getNote(self, seqid, iprot, oprot):
        ...
        result = getNote_result()
        try:
            result.success = self._handler.getNote(
                args.authenticationToken,
                args.guid,
                args.withContent,
    ...
    def process_getNoteApplicationData(self, seqid, iprot, oprot):
        ...
        result = getNoteApplicationData_result()
        try:
            result.success = self._handler.getNoteApplicationData(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_getNoteApplicationDataEntry(self, seqid, iprot, oprot):
        ...
        result = getNoteApplicationDataEntry_result()
        try:
            result.success = self._handler.getNoteApplicationDataEntry(
                args.authenticationToken, args.guid, args.key
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
        ...
        oprot.writeMessageBegin(
            "getNoteApplicationDataEntry", TMessageType.REPLY, seqid
        )
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_setNoteApplicationDataEntry(self, seqid, iprot, oprot):
        ...
        result = setNoteApplicationDataEntry_result()
        try:
            result.success = self._handler.setNoteApplicationDataEntry(
                args.authenticationToken, args.guid, args.key, args.value
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
            ...
            result.notFoundException = notFoundException
        oprot.writeMessageBegin(
            "setNoteApplicationDataEntry", TMessageType.REPLY, seqid
        )
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_unsetNoteApplicationDataEntry(self, seqid, iprot, oprot):
        ...
        result = unsetNoteApplicationDataEntry_result()
        try:
            result.success = self._handler.unsetNoteApplicationDataEntry(
                args.authenticationToken, args.guid, args.key
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
            ...
            result.notFoundException = notFoundException
        oprot.writeMessageBegin(
            "unsetNoteApplicationDataEntry", TMessageType.REPLY, seqid
        )
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_getNoteContent(self, seqid, iprot, oprot):
        ...
        result = getNoteContent_result()
        try:
            result.success = self._handler.getNoteContent(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_getNoteSearchText(self, seqid, iprot, oprot):
        ...
        result = getNoteSearchText_result()
        try:
            result.success = self._handler.getNoteSearchText(
                args.authenticationToken,
                args.guid,
                args.noteOnly,
    ...
    def process_getResourceSearchText(self, seqid, iprot, oprot):
        ...
        result = getResourceSearchText_result()
        try:
            result.success = self._handler.getResourceSearchText(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_getNoteTagNames(self, seqid, iprot, oprot):
        ...
        result = getNoteTagNames_result()
        try:
            result.success = self._handler.getNoteTagNames(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_createNote(self, seqid, iprot, oprot):
        ...
        result = createNote_result()
        try:
            result.success = self._handler.createNote(
                args.authenticationToken, args.note
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
    ...
    def process_updateNote(self, seqid, iprot, oprot):
        ...
        result = updateNote_result()
        try:
            result.success = self._handler.updateNote(
                args.authenticationToken, args.note
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_deleteNote(self, seqid, iprot, oprot):
        ...
        result = deleteNote_result()
        try:
            result.success = self._handler.deleteNote(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_expungeNote(self, seqid, iprot, oprot):
        ...
        result = expungeNote_result()
        try:
            result.success = self._handler.expungeNote(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_expungeNotes(self, seqid, iprot, oprot):
        ...
        result = expungeNotes_result()
        try:
            result.success = self._handler.expungeNotes(
                args.authenticationToken, args.noteGuids
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
    ...
    def process_expungeInactiveNotes(self, seqid, iprot, oprot):
        ...
        result = expungeInactiveNotes_result()
        try:
            result.success = self._handler.expungeInactiveNotes(
                args.authenticationToken
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_copyNote(self, seqid, iprot, oprot):
        ...
        result = copyNote_result()
        try:
            result.success = self._handler.copyNote(
                args.authenticationToken, args.noteGuid, args.toNotebookGuid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
    ...
    def process_listNoteVersions(self, seqid, iprot, oprot):
        ...
        result = listNoteVersions_result()
        try:
            result.success = self._handler.listNoteVersions(
                args.authenticationToken, args.noteGuid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
    ...
    def process_getNoteVersion(self, seqid, iprot, oprot):
        ...
        result = getNoteVersion_result()
        try:
            result.success = self._handler.getNoteVersion(
                args.authenticationToken,
                args.noteGuid,
    ...
    def process_getResource(self, seqid, iprot, oprot):
        ...
        result = getResource_result()
        try:
            result.success = self._handler.getResource(
                args.authenticationToken,
                args.guid,
                args.withData,
    ...
    def process_getResourceApplicationData(self, seqid, iprot, oprot):
        ...
        result = getResourceApplicationData_result()
        try:
            result.success = self._handler.getResourceApplicationData(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_getResourceApplicationDataEntry(self, seqid, iprot, oprot):
        ...
        result = getResourceApplicationDataEntry_result()
        try:
            result.success = self._handler.getResourceApplicationDataEntry(
                args.authenticationToken, args.guid, args.key
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
            ...
            result.notFoundException = notFoundException
        oprot.writeMessageBegin(
            "getResourceApplicationDataEntry", TMessageType.REPLY, seqid
        )
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_setResourceApplicationDataEntry(self, seqid, iprot, oprot):
        ...
        result = setResourceApplicationDataEntry_result()
        try:
            result.success = self._handler.setResourceApplicationDataEntry(
                args.authenticationToken, args.guid, args.key, args.value
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
            ...
            result.notFoundException = notFoundException
        oprot.writeMessageBegin(
            "setResourceApplicationDataEntry", TMessageType.REPLY, seqid
        )
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_unsetResourceApplicationDataEntry(self, seqid, iprot, oprot):
        ...
        result = unsetResourceApplicationDataEntry_result()
        try:
            result.success = self._handler.unsetResourceApplicationDataEntry(
                args.authenticationToken, args.guid, args.key
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
            ...
            result.notFoundException = notFoundException
        oprot.writeMessageBegin(
            "unsetResourceApplicationDataEntry", TMessageType.REPLY, seqid
        )
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_updateResource(self, seqid, iprot, oprot):
        ...
        result = updateResource_result()
        try:
            result.success = self._handler.updateResource(
                args.authenticationToken, args.resource
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
    ...
    def process_getResourceData(self, seqid, iprot, oprot):
        ...
        result = getResourceData_result()
        try:
            result.success = self._handler.getResourceData(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_getResourceByHash(self, seqid, iprot, oprot):
        ...
        result = getResourceByHash_result()
        try:
            result.success = self._handler.getResourceByHash(
                args.authenticationToken,
                args.noteGuid,
                args.contentHash,
                args.withData,
    ...
    def process_getResourceRecognition(self, seqid, iprot, oprot):
        ...
        result = getResourceRecognition_result()
        try:
            result.success = self._handler.getResourceRecognition(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_getResourceAlternateData(self, seqid, iprot, oprot):
        ...
        result = getResourceAlternateData_result()
        try:
            result.success = self._handler.getResourceAlternateData(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_getResourceAttributes(self, seqid, iprot, oprot):
        ...
        result = getResourceAttributes_result()
        try:
            result.success = self._handler.getResourceAttributes(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_getPublicNotebook(self, seqid, iprot, oprot):
        ...
        result = getPublicNotebook_result()
        try:
            result.success = self._handler.getPublicNotebook(
                args.userId, args.publicUri
            )
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
            result.systemException = systemException
        except noco.evernote.edam.error.ttypes.EDAMNotFoundException as notFoundException:
    ...
    def process_createSharedNotebook(self, seqid, iprot, oprot):
        ...
        result = createSharedNotebook_result()
        try:
            result.success = self._handler.createSharedNotebook(
                args.authenticationToken, args.sharedNotebook
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMNotFoundException as notFoundException:
    ...
    def process_updateSharedNotebook(self, seqid, iprot, oprot):
        ...
        result = updateSharedNotebook_result()
        try:
            result.success = self._handler.updateSharedNotebook(
                args.authenticationToken, args.sharedNotebook
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_setSharedNotebookRecipientSettings(self, seqid, iprot, oprot):
        ...
        result = setSharedNotebookRecipientSettings_result()
        try:
            result.success = self._handler.setSharedNotebookRecipientSettings(
                args.authenticationToken, args.sharedNotebookId, args.recipientSettings
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMNotFoundException as notFoundException:
            ...
            result.systemException = systemException
        oprot.writeMessageBegin(
            "setSharedNotebookRecipientSettings", TMessageType.REPLY, seqid
        )
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_sendMessageToSharedNotebookMembers(self, seqid, iprot, oprot):
        ...
        result = sendMessageToSharedNotebookMembers_result()
        try:
            result.success = self._handler.sendMessageToSharedNotebookMembers(
                args.authenticationToken,
                args.notebookGuid,
                args.messageText,
                args.recipients,
            ...
            result.systemException = systemException
        oprot.writeMessageBegin(
            "sendMessageToSharedNotebookMembers", TMessageType.REPLY, seqid
        )
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_expungeSharedNotebooks(self, seqid, iprot, oprot):
        ...
        result = expungeSharedNotebooks_result()
        try:
            result.success = self._handler.expungeSharedNotebooks(
                args.authenticationToken, args.sharedNotebookIds
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMNotFoundException as notFoundException:
    ...
    def process_createLinkedNotebook(self, seqid, iprot, oprot):
        ...
        result = createLinkedNotebook_result()
        try:
            result.success = self._handler.createLinkedNotebook(
                args.authenticationToken, args.linkedNotebook
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_updateLinkedNotebook(self, seqid, iprot, oprot):
        ...
        result = updateLinkedNotebook_result()
        try:
            result.success = self._handler.updateLinkedNotebook(
                args.authenticationToken, args.linkedNotebook
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_expungeLinkedNotebook(self, seqid, iprot, oprot):
        ...
        result = expungeLinkedNotebook_result()
        try:
            result.success = self._handler.expungeLinkedNotebook(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_authenticateToSharedNotebook(self, seqid, iprot, oprot):
        ...
        result = authenticateToSharedNotebook_result()
        try:
            result.success = self._handler.authenticateToSharedNotebook(
                args.shareKey, args.authenticationToken
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMNotFoundException as notFoundException:
            ...
            result.systemException = systemException
        oprot.writeMessageBegin(
            "authenticateToSharedNotebook", TMessageType.REPLY, seqid
        )
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_getSharedNotebookByAuth(self, seqid, iprot, oprot):
        ...
        result = getSharedNotebookByAuth_result()
        try:
            result.success = self._handler.getSharedNotebookByAuth(
                args.authenticationToken
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_shareNote(self, seqid, iprot, oprot):
        ...
        result = shareNote_result()
        try:
            result.success = self._handler.shareNote(
                args.authenticationToken, args.guid
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
    ...
    def process_authenticateToSharedNote(self, seqid, iprot, oprot):
        ...
        result = authenticateToSharedNote_result()
        try:
            result.success = self._handler.authenticateToSharedNote(
                args.guid, args.noteKey, args.authenticationToken
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMNotFoundException as notFoundException:
    ...
    def process_findRelated(self, seqid, iprot, oprot):
        ...
        result = findRelated_result()
        try:
            result.success = self._handler.findRelated(
                args.authenticationToken, args.query, args.resultSpec
            )
        except noco.evernote.edam.error.ttypes.EDAMUserException as userException:
            result.userException = userException
        except noco.evernote.edam.error.ttypes.EDAMSystemException as systemException:
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            "userException",
            (
                noco.evernote.edam.error.ttypes.EDAMUserException,
                noco.evernote.edam.error.ttypes.EDAMUserException.thrift_spec,
            ),
            None,
        ),  # 1
        (
            ...
            "systemException",
            (
                noco.evernote.edam.error.ttypes.EDAMSystemException,
                noco.evernote.edam.error.ttypes.EDAMSystemException.thrift_spec,
            ),
            None,
        ),  # 2
    )
    ...
    def __init__(
        self, success=None, userException=None, systemException=None,
    ):
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            TType.STRUCT,
            "clientMetrics",
            (ClientUsageMetrics, ClientUsageMetrics.thrift_spec),
            None,
        ),  # 2
    )

    def __init__(
        self, authenticationToken=None, clientMetrics=None,
    ):
        self.authenticationToken = authenticationToken
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            TType.STRUCT,
            "filter",
            (SyncChunkFilter, SyncChunkFilter.thrift_spec),
            None,
        ),  # 4
    )

    def __init__(
        self, authenticationToken=None, afterUSN=None, maxEntries=None, filter=None,
    ):
        self.authenticationToken = authenticationToken
        self.afterUSN = afterUSN
        self.maxEntries = maxEntries
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            "linkedNotebook",
            (
                noco.evernote.edam.type.ttypes.LinkedNotebook,
                noco.evernote.edam.type.ttypes.LinkedNotebook.thrift_spec,
            ),
            None,
        ),  # 2
    )
    ...
    def __init__(
        self, authenticationToken=None, linkedNotebook=None,
    ):
        self.authenticationToken = authenticationToken
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            "notFoundException",
            (
                noco.evernote.edam.error.ttypes.EDAMNotFoundException,
                noco.evernote.edam.error.ttypes.EDAMNotFoundException.thrift_spec,
            ),
            None,
        ),  # 3
    )
    ...
    thrift_spec = (
        (
            ...
            (
                TType.STRUCT,
                (
                    noco.evernote.edam.type.ttypes.Notebook,
                    noco.evernote.edam.type.ttypes.Notebook.thrift_spec,
                ),
            ),
            None,
        ),
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i197 in range(_size193):
                        _elem198 = noco.evernote.edam.type.ttypes.Notebook()
                        _elem198.read(iprot)
...
class getNotebook_args(object):
  ...
  """
    ...
    def __init__(
        self, authenticationToken=None, guid=None,
    ):
        self.authenticationToken = authenticationToken
        self.guid = guid
  ...
  """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = noco.evernote.edam.type.ttypes.Notebook()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class createNotebook_args(object):
  ...
  """
    ...
    def __init__(
        self, authenticationToken=None, notebook=None,
    ):
        self.authenticationToken = authenticationToken
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.notebook = noco.evernote.edam.type.ttypes.Notebook()
    ...
    thrift_spec = (
        (
            ...
            (
                TType.STRUCT,
                (
                    noco.evernote.edam.type.ttypes.Tag,
                    noco.evernote.edam.type.ttypes.Tag.thrift_spec,
                ),
            ),
            None,
        ),  # 0
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i204 in range(_size200):
                        _elem205 = noco.evernote.edam.type.ttypes.Tag()
                        _elem205.read(iprot)
...
class listTagsByNotebook_args(object):
  ...
  """
    ...
    def __init__(
        self, authenticationToken=None, notebookGuid=None,
    ):
        self.authenticationToken = authenticationToken
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i211 in range(_size207):
                        _elem212 = noco.evernote.edam.type.ttypes.Tag()
                        _elem212.read(iprot)
  ...
  """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = noco.evernote.edam.type.ttypes.Tag()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class createTag_args(object):
  ...
  """
    ...
    def __init__(
        self, authenticationToken=None, tag=None,
    ):
        self.authenticationToken = authenticationToken
        self.tag = tag
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.tag = noco.evernote.edam.type.ttypes.Tag()
                    self.tag.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
...
class untagAll_result(object):
  ...
  """
    ...
    def __init__(
        self, userException=None, systemException=None, notFoundException=None,
    ):
        self.userException = userException
        self.systemException = systemException
        self.notFoundException = notFoundException
    ...
    thrift_spec = (
        (
            ...
            (
                TType.STRUCT,
                (
                    noco.evernote.edam.type.ttypes.SavedSearch,
                    noco.evernote.edam.type.ttypes.SavedSearch.thrift_spec,
                ),
            ),
            None,
        ),  # 0
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i218 in range(_size214):
                        _elem219 = noco.evernote.edam.type.ttypes.SavedSearch()
                        _elem219.read(iprot)
  ...
  """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = noco.evernote.edam.type.ttypes.SavedSearch()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class createSearch_args(object):
  ...
  """
    ...
    def __init__(
        self, authenticationToken=None, search=None,
    ):
        self.authenticationToken = authenticationToken
        self.search = search
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.search = noco.evernote.edam.type.ttypes.SavedSearch()
...
class findNotes_args(object):
  ...
  """
    ...
    def __init__(
        self, authenticationToken=None, filter=None, offset=None, maxNotes=None,
    ):
        self.authenticationToken = authenticationToken
        self.filter = filter
        self.offset = offset
...
class findNoteOffset_args(object):
  ...
  """
    ...
    def __init__(
        self, authenticationToken=None, filter=None, guid=None,
    ):
        self.authenticationToken = authenticationToken
        self.filter = filter
        self.guid = guid
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            TType.STRUCT,
            "resultSpec",
            (NotesMetadataResultSpec, NotesMetadataResultSpec.thrift_spec),
            None,
        ),  # 5
    )
  ...
  """
    ...
    thrift_spec = (
        (
            ...
            TType.STRUCT,
            "success",
            (NotesMetadataList, NotesMetadataList.thrift_spec),
            None,
        ),  # 0
        (
            1,
...
class findNoteCounts_args(object):
  ...
  """
    ...
    def __init__(
        self, authenticationToken=None, filter=None, withTrash=None,
    ):
        self.authenticationToken = authenticationToken
        self.filter = filter
  ...
  """
    ...
    thrift_spec = (
        (
            ...
            TType.STRUCT,
            "success",
            (NoteCollectionCounts, NoteCollectionCounts.thrift_spec),
            None,
        ),  # 0
        (
            1,
...
class getNote_args(object):
  ...
  """
    ...
    def __init__(
        ...
        guid=None,
        withContent=None,
        withResourcesData=None,
        withResourcesRecognition=None,
        withResourcesAlternateData=None,
    ):
        self.authenticationToken = authenticationToken
        self.guid = guid
  ...
  """
    ...
    thrift_spec = (
        (
            ...
            "success",
            (
                noco.evernote.edam.type.ttypes.Note,
                noco.evernote.edam.type.ttypes.Note.thrift_spec,
            ),
            None,
        ),  # 0
        (
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = noco.evernote.edam.type.ttypes.Note()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
  ...
  """
    ...
    thrift_spec = (
        (
            ...
            "success",
            (
                noco.evernote.edam.type.ttypes.LazyMap,
                noco.evernote.edam.type.ttypes.LazyMap.thrift_spec,
            ),
            None,
        ),  # 0
        (
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = noco.evernote.edam.type.ttypes.LazyMap()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class getNoteApplicationDataEntry_args(object):
  ...
  """
    ...
    def __init__(
        self, authenticationToken=None, guid=None, key=None,
    ):
        self.authenticationToken = authenticationToken
        self.guid = guid
        self.key = key
...
class setNoteApplicationDataEntry_args(object):
  ...
  """
    ...
    def __init__(
        self, authenticationToken=None, guid=None, key=None, value=None,
    ):
        self.authenticationToken = authenticationToken
        self.guid = guid
        self.key = key
...
class createNote_args(object):
  ...
  """
    ...
    def __init__(
        self, authenticationToken=None, note=None,
    ):
        self.authenticationToken = authenticationToken
        self.note = note
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.note = noco.evernote.edam.type.ttypes.Note()
...
class expungeNotes_args(object):
  ...
  """
    ...
    def __init__(
        self, authenticationToken=None, noteGuids=None,
    ):
        self.authenticationToken = authenticationToken
...
class copyNote_args(object):
  ...
  """
    ...
    def __init__(
        self, authenticationToken=None, noteGuid=None, toNotebookGuid=None,
    ):
        self.authenticationToken = authenticationToken
...
class listNoteVersions_args(object):
  ...
  """
    ...
    def __init__(
        self, authenticationToken=None, noteGuid=None,
    ):
        self.authenticationToken = authenticationToken
        self.noteGuid = noteGuid
  ...
  """
    ...
    thrift_spec = (
        (
            ...
            TType.LIST,
            "success",
            (TType.STRUCT, (NoteVersionId, NoteVersionId.thrift_spec)),
            None,
        ),  # 0
        (
            1,
  ...
  """
    ...
    thrift_spec = (
        (
            ...
            "success",
            (
                noco.evernote.edam.type.ttypes.Resource,
                noco.evernote.edam.type.ttypes.Resource.thrift_spec,
            ),
            None,
        ),  # 0
        (
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = noco.evernote.edam.type.ttypes.Resource()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class updateResource_args(object):
  ...
  """
    ...
    def __init__(
        self, authenticationToken=None, resource=None,
    ):
        self.authenticationToken = authenticationToken
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.resource = noco.evernote.edam.type.ttypes.Resource()
  ...
  """
    ...
    thrift_spec = (
        (
            ...
            "success",
            (
                noco.evernote.edam.type.ttypes.ResourceAttributes,
                noco.evernote.edam.type.ttypes.ResourceAttributes.thrift_spec,
            ),
            None,
        ),  # 0
        (
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = noco.evernote.edam.type.ttypes.ResourceAttributes()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class getPublicNotebook_args(object):
  ...
  """
    ...
    def __init__(
        self, userId=None, publicUri=None,
    ):
        self.userId = userId
...
class getPublicNotebook_result(object):
  ...
  """
    ...
    def __init__(
        self, success=None, systemException=None, notFoundException=None,
    ):
        self.success = success
        self.systemException = systemException
        self.notFoundException = notFoundException
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            "sharedNotebook",
            (
                noco.evernote.edam.type.ttypes.SharedNotebook,
                noco.evernote.edam.type.ttypes.SharedNotebook.thrift_spec,
            ),
            None,
        ),  # 2
    )
    ...
    def __init__(
        self, authenticationToken=None, sharedNotebook=None,
    ):
        self.authenticationToken = authenticationToken
  ...
  """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = noco.evernote.edam.type.ttypes.SharedNotebook()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            "recipientSettings",
            (
                noco.evernote.edam.type.ttypes.SharedNotebookRecipientSettings,
                noco.evernote.edam.type.ttypes.SharedNotebookRecipientSettings.thrift_spec,
            ),
            None,
        ),  # 3
    )
    ...
    def __init__(
        self, authenticationToken=None, sharedNotebookId=None, recipientSettings=None,
    ):
        self.authenticationToken = authenticationToken
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i253 in range(_size249):
                        _elem254 = noco.evernote.edam.type.ttypes.SharedNotebook()
                        _elem254.read(iprot)
...
class expungeSharedNotebooks_args(object):
  ...
  """
    ...
    def __init__(
        self, authenticationToken=None, sharedNotebookIds=None,
    ):
        self.authenticationToken = authenticationToken
  ...
  """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = noco.evernote.edam.type.ttypes.LinkedNotebook()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i267 in range(_size263):
                        _elem268 = noco.evernote.edam.type.ttypes.LinkedNotebook()
                        _elem268.read(iprot)
...
class authenticateToSharedNotebook_args(object):
  ...
  """
    ...
    def __init__(
        self, shareKey=None, authenticationToken=None,
    ):
  ...
  """
    ...
    thrift_spec = (
        (
            ...
            "success",
            (
                noco.evernote.edam.userstore.ttypes.AuthenticationResult,
                noco.evernote.edam.userstore.ttypes.AuthenticationResult.thrift_spec,
            ),
            None,
        ),  # 0
        (
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            TType.STRUCT,
            "parameters",
            (NoteEmailParameters, NoteEmailParameters.thrift_spec),
            None,
        ),  # 2
    )

    def __init__(
        self, authenticationToken=None, parameters=None,
    ):
        self.authenticationToken = authenticationToken
...
class emailNote_result(object):
  ...
  """
    ...
    def __init__(
        self, userException=None, notFoundException=None, systemException=None,
    ):
        self.userException = userException
        self.notFoundException = notFoundException
        self.systemException = systemException
...
class authenticateToSharedNote_args(object):
  ...
  """
    ...
    def __init__(
        self, guid=None, noteKey=None, authenticationToken=None,
    ):
        self.guid = guid
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            TType.STRUCT,
            "query",
            (RelatedQuery, RelatedQuery.thrift_spec),
            None,
        ),  # 2
        (
            3,
            TType.STRUCT,
            "resultSpec",
            (RelatedResultSpec, RelatedResultSpec.thrift_spec),
            None,
        ),  # 3
    )

    def __init__(
        self, authenticationToken=None, query=None, resultSpec=None,
    ):
        self.authenticationToken = authenticationToken
        self.query = query
        self.resultSpec = resultSpec
  ...
  """
    ...
    thrift_spec = (
        (
            ...
            TType.STRUCT,
            "success",
            (RelatedResult, RelatedResult.thrift_spec),
            None,
        ),  # 0
        (
            1,
