...
class Data(object):
  ...
  """
    ...
    def __init__(
        self, bodyHash=None, size=None, body=None,
    ):
...
class UserAttributes(object):
  ...
  """
    ...
    def __init__(
        ...
        preactivation=None,
        viewedPromotions=None,
        incomingEmailAddress=None,
        recentMailedAddresses=None,
        comments=None,
        dateAgreedToTermsOfService=None,
        maxReferrals=None,
        referralCount=None,
        refererCode=None,
        sentEmailDate=None,
        sentEmailCount=None,
        dailyEmailLimit=None,
        emailOptOutDate=None,
        partnerEmailOptInDate=None,
        ...
        referralProof=None,
        educationalDiscount=None,
        businessAddress=None,
        hideSponsorBilling=None,
        taxExempt=None,
        useEmailAutoFiling=None,
        reminderEmailConfig=None,
    ):
...
class Accounting(object):
  ...
  """
    ...
    def __init__(
        ...
        uploadLimit=None,
        uploadLimitEnd=None,
        uploadLimitNextMonth=None,
        premiumServiceStatus=None,
...
class BusinessUserInfo(object):
  ...
  """
    ...
    def __init__(
        self, businessId=None, businessName=None, role=None, email=None,
    ):
        self.businessId = businessId
        self.businessName = businessName
        self.role = role
...
class PremiumInfo(object):
  ...
  """
    ...
    def __init__(
        ...
        currentTime=None,
        premium=None,
        premiumRecurring=None,
        premiumExpirationDate=None,
        premiumExtendable=None,
        premiumPending=None,
        premiumCancellationPending=None,
        canPurchaseUploadAllowance=None,
        sponsoredGroupName=None,
        sponsoredGroupRole=None,
    ...
    def validate(self):
        ...
        if self.premium is None:
            raise TProtocol.TProtocolException(
                message="Required field premium is unset!"
            )
        if self.premiumRecurring is None:
            raise TProtocol.TProtocolException(
                message="Required field premiumRecurring is unset!"
            )
        if self.premiumExtendable is None:
            raise TProtocol.TProtocolException(
                message="Required field premiumExtendable is unset!"
            )
        if self.premiumPending is None:
            raise TProtocol.TProtocolException(
                message="Required field premiumPending is unset!"
            )
        if self.premiumCancellationPending is None:
            raise TProtocol.TProtocolException(
                message="Required field premiumCancellationPending is unset!"
            )
        if self.canPurchaseUploadAllowance is None:
            raise TProtocol.TProtocolException(
                message="Required field canPurchaseUploadAllowance is unset!"
            )
        return
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            TType.STRUCT,
            "attributes",
            (UserAttributes, UserAttributes.thrift_spec),
            None,
        ),  # 15
        (
            16,
            TType.STRUCT,
            "accounting",
            (Accounting, Accounting.thrift_spec),
            None,
        ),  # 16
        (
            17,
            TType.STRUCT,
            "premiumInfo",
            (PremiumInfo, PremiumInfo.thrift_spec),
            None,
        ),  # 17
        (
            18,
            TType.STRUCT,
            "businessUserInfo",
            (BusinessUserInfo, BusinessUserInfo.thrift_spec),
            None,
        ),  # 18
    )
...
class Tag(object):
  ...
  """
    ...
    def __init__(
        self, guid=None, name=None, parentGuid=None, updateSequenceNum=None,
    ):
        self.guid = guid
        self.name = name
...
class LazyMap(object):
  ...
  """
    ...
    def __init__(
        self, keysOnly=None, fullMap=None,
    ):
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            TType.STRUCT,
            "attributes",
            (ResourceAttributes, ResourceAttributes.thrift_spec),
            None,
        ),  # 11
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            TType.MAP,
            "classifications",
            (TType.STRING, None, TType.STRING, None),
            None,
        ),  # 26
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            TType.LIST,
            "resources",
            (TType.STRUCT, (Resource, Resource.thrift_spec)),
            None,
        ),  # 13
        (
            14,
            TType.STRUCT,
            "attributes",
            (NoteAttributes, NoteAttributes.thrift_spec),
            None,
        ),  # 14
...
class Publishing(object):
  ...
  """
    ...
    def __init__(
        self, uri=None, order=None, ascending=None, publicDescription=None,
    ):
        self.uri = uri
        self.order = order
...
class BusinessNotebook(object):
  ...
  """
    ...
    def __init__(
        self, notebookDescription=None, privilege=None, recommended=None,
    ):
...
class SavedSearchScope(object):
  ...
  """
    ...
    def __init__(
        self,
        includeAccount=None,
        includePersonalLinkedNotebooks=None,
        includeBusinessLinkedNotebooks=None,
    ):
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            TType.STRUCT,
            "scope",
            (SavedSearchScope, SavedSearchScope.thrift_spec),
            None,
        ),  # 6
    )
...
class SharedNotebookRecipientSettings(object):
  ...
  """
    ...
    def __init__(
        self, reminderNotifyEmail=None, reminderNotifyInApp=None,
    ):
...
class NotebookRestrictions(object):
  ...
  """
    ...
    def __init__(
        ...
        self.updateWhichSharedNotebookRestrictions = (
            updateWhichSharedNotebookRestrictions
        )
  ...
  """
    ...
    thrift_spec = (
        ...
        (
            ...
            TType.STRUCT,
            "publishing",
            (Publishing, Publishing.thrift_spec),
            None,
        ),  # 10
        ...
        (
            ...
            TType.LIST,
            "sharedNotebooks",
            (TType.STRUCT, (SharedNotebook, SharedNotebook.thrift_spec)),
            None,
        ),  # 14
        (
            15,
            TType.STRUCT,
            "businessNotebook",
            (BusinessNotebook, BusinessNotebook.thrift_spec),
            None,
        ),  # 15
        ...
        (
            ...
            TType.STRUCT,
            "restrictions",
            (NotebookRestrictions, NotebookRestrictions.thrift_spec),
            None,
        ),  # 17
    )
...
class NotebookDescriptor(object):
  ...
  """
    ...
    def __init__(
        self,
        guid=None,
        notebookDisplayName=None,
        contactName=None,
        hasSharedNotebook=None,
